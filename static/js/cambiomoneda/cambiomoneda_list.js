...
let controller_name = '/cambiomoneda_controller/'
...
function get_data_columns(item) {
    return [
        { data: `${item.cuenta_origen_desc}`, class: '' },
        { data: item.monto_cambiar, class: '' },
        { data: item.tipo_cambio, class: '' },
        { data: item.monto_cambiado, class: '' },
    ]
}
