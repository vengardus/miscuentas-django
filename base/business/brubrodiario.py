...
class BRubroDiario(Table):
    ...
    def get_oTO_toDict(self, oTO:RubroDiario):
        ...
        return {
            ...
            'is_servicio':oTO.is_servicio
        }

    ''' ----------------------
        Métodos personalizados
    '''
    def _set_oTO(self, oTO:RubroDiario, data:list(), mode, request):
        '''
            Personalizar oTO
        '''
        ...
        oTO.is_servicio = data['is_servicio']
