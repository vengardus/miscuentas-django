...
def cambiomoneda_controller(request):
...
class ControllerCustom(Controller):
    ...
    def __init__(self, data, request):
        ...
        self.set_actions()
        self.url_action_new = 'cambiomoneda_form'
    ...
    def action_refresh(self):
        ...
        print(oBModel.aTO)
        self.context['aDataTable'] = oBModel.get_aTO_toArray()
        print(self.context['aDataTable'])
        self.context['action_new'] = reverse(self.url_action_new, args=['new', 0]); #'cambiomoneda_form'
    ...
    def set_grid_columns(self):
        ...
        '''
        return [ 
                ('Origen', 'M.Cambiar', 'T.C', 'M.Cambio', 'Acción'),
        ]
